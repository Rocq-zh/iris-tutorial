...
(**
  The implementation of Iris in Rocq has a unique class of propositions
  called `pure'. This class arises from the fact that Rocq propositions
  can be embedded into the logic of Iris. Any Rocq proposition [φ : Prop]
  can be turned into an Iris proposition through the pure embedding
  [⌜φ⌝ : iProp Σ]. This allows us to piggyback on much of the
  functionality and theory developed for the logic of Rocq. The
...
(**
  ...
  exists a Rocq proposition [φ], such that [P ⊣⊢ ⌜φ⌝].
